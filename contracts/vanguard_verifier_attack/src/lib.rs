...
//! Vanguard Verifier Contract - Attack Circuit
//!
//! Minimal wrapper around the official Noir UltraHonk verifier for Soroban.
//! This contract ONLY verifies attack proofs - no game logic.
...
#[contract]
pub struct VanguardVerifierAttackContract;

#[contractimpl]
impl VanguardVerifierAttackContract {
    /// Verify an UltraHonk proof for the attack circuit using the embedded verification key.
    ///
