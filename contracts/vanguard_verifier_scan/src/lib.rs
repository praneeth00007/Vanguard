...
//! Vanguard Verifier Contract - Scan Circuit
//!
//! Minimal wrapper around the official Noir UltraHonk verifier for Soroban.
//! This contract ONLY verifies scan proofs - no game logic.
...
#[contract]
pub struct VanguardVerifierScanContract;

#[contractimpl]
impl VanguardVerifierScanContract {
    /// Verify an UltraHonk proof for the scan circuit using the embedded verification key.
    ///
